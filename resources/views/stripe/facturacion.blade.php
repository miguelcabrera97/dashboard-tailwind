                ...
                <tbody>
                 ...
                 @foreach ($invoices as $invoice) 
                  <tr>
                    ...
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                      <a href="{{$invoice->hosted_invoice_url}}" target="blank_"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                      <span class="capitalize"><a href="{{$invoice->invoice_pdf}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-cloud-arrow-down" viewBox="0 0 16 16">
